...
ul.abt-sidebar-slider .overlayx,ul.abt-sidebar-slider img{border:2px solid #0000ff;-moz-border-radius:3px;-webkit-border-radius:3px;border-radius:3px}
...
ul.abt-sidebar-slider h4{position:absolute;bottom:10px;z-index:2;color:white;margin:0;width:100%;padding:0 10px;line-height:1.2em;font-family:Georgia,Times,"Times New Roman";font-weight:normal}
ul.abt-sidebar-slider li:nth-child(1) h4,ul.abt-sidebar-slider li:nth-child(4) h4{font-size:120%}
ul.abt-sidebar-slider .label_text{position:absolute;bottom:10px;left:10px;z-index:2;color:white;font-size:10%}
...
.buttons a::before{content:"";width:0;height:0;border-width:8px 7px;border-style:solid;border-color:transparent #ff0000 transparent transparent;position:absolute;top:50%;margin-top:-8px;margin-left:-10px;left:50%}
.buttons a.nextx::before{border-color:transparent transparent transparent #ff0000;margin-left:-3px}
